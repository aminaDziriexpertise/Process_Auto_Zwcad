...
def main():
     ...
     def plotNote():
      ...
      p0.Color = 0
      p = acad.model.AddText("Calcul réalisé à partir des relevés effectués en"+Cree__le+"par GEXPERTISE CONSEIL ",p1,0.5)
      p.Color = 0
      p1 = acad.model.AddText( "les affectations des locaux  correspondent aux occupations apparentes le jour du mesurage.",p2,0.5)
      p1.Color = 0
      return p 
     ...
     def plotNum_dossier():
      ...
      p = acad.model.AddText(Num_Dossier, p, 0.7)
      p.Color = 0
      return p 

     def plotNum_Archive():
      p= APoint(1653951.9483,8210308.6641,0.00)
      p = acad.model.AddText(Num_Arch, p, 0.7)
      p.Color = 0
      return p
